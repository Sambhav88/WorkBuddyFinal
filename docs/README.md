...
### Backend
1. Configure database connection in `application.properties` (uses environment variables from `.env` file)
2. Run the Spring Boot application
3. The API will be available at `http://localhost:8082`
...
3. The backend API will be available at http://localhost:8082
